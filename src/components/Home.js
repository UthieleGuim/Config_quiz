...
const Home = () => {
    ...
    <div>
      <section className="hero">
        ...
        >
          ...
          <div style={{ flex: '1 1 300px', minWidth: '280px', maxWidth: '400px', textAlign: 'center' }}>
            <img
            ...
            />
            {/* Texto adicional ao lado da imagem */}
            <div style={{ marginTop: '1rem', fontSize: '1.1em', color: '#1E3A8A' }}>
              <strong>Dica:</strong> Um e-mail profissional transmite mais confiança!
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', marginTop: '1.5rem' }}>
          <div className="card-body">
            <div style={{ flex: '1', minWidth: '200px' }}>
              ...
              <article className="email-type">
                <h3>Pessoal</h3>
                <ul>
                  <li><strong>Endereço:</strong> Pode usar apelidos, números, domínios genéricos (gmail.com, yahoo.com etc.)</li>
                  <li><strong>Uso / Contexto:</strong> Amigos, familiares, lazer, redes sociais</li>
                  <li><strong>Segurança:</strong> Menos controle, autenticação simples</li>
                  <li><strong>Provedor:</strong> Serviços gratuitos, sem domínio próprio</li>
                </ul>
              </article>
              ...
              <article className="email-type">
                <h3>Profissional</h3>
                <ul>
                  <li><strong>Endereço:</strong> Domínio da empresa (nome@empresa.com)</li>
                  <li><strong>Uso / Contexto:</strong> Comunicação formal, clientes, fornecedores</li>
                  <li><strong>Segurança:</strong> Senhas fortes, 2FA, políticas rígidas</li>
                  <li><strong>Provedor:</strong> Google Workspace, Microsoft 365, Zoho</li>
                </ul>
              </article>
  ...
  <div className="email-text">
    <h4>Complemento</h4>
    <p>Informações adicionais sobre tipos de e-mail e recomendações para uso profissional.</p>
  </div>
      ...
      <section className="card">
        <div className="card-body">
          ...
          <article className="security-tip">
            <h4>Senhas Fortes</h4>
            <p>Usar senhas longas (idealmente: 12 caracteres), misturando letras maiúsculas e minúsculas, números e símbolos.</p>
            <p>Não usar senhas óbvias ou baseadas em informações pessoais (ex: datas de nascimento).</p>
            <p>Utilizar senhas diferentes para diferentes serviços (se possível), para evitar que comprometimento de um serviço leve aos outros.</p>
          </article>

          <article className="security-tip">
            <h4>Autenticação de Dois Fatores (2FA)</h4>
            <p>Sempre ativar 2FA se o provedor permitir (via SMS, app autenticador ou tokens de hardware).</p>
            <p>Em ambientes corporativos, usar autenticação multifator mais forte possível.</p>
            <p>Verificar métodos de recuperação de conta para não perder acesso.</p>
          </article>

          <article className="security-tip">
            <h4>Protocolos e Criptografia</h4>
            <p>Usar protocolos seguros, criptografia de transporte (TLS/SSL) nas conexões (recepção e envio de e-mail).</p>
            <p>Configurar SPF, DKIM e DMARC no domínio da empresa para evitar falsificação de remetente (spoofing).</p>
          </article>

          <article className="security-tip">
            <h4>Monitoramento e Manutenção</h4>
            <p>Monitorar logs de acesso e tentativas de login suspeitas.</p>
            <p>Verificar configurações de encaminhamento automático de e-mail.</p>
            <p>Atualizar softwares de cliente de e-mail, servidor e plugins para corrigir vulnerabilidades.</p>
          </article>

          <article className="security-tip">
            <h4>Educação do Usuário</h4>
            <p>Educar usuários sobre phishing, anexos suspeitos e links perigosos.</p>
          </article>
        </div>
      </section>
        ...
        <div className="card-body">
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem', marginTop: '1.5rem' }}>
            <div style={{ flex: '1', minWidth: '200px' }}>
              ...
              <p>Para um e-mail profissional, a segurança é crítica. Utilizar senhas diferentes para diferentes serviços (se possível), para evitar que comprometimento de um serviço leve aos outros.</p>
            </div>
            <div style={{ flex: '1', minWidth: '200px' }}>
              <h3>  Observações Importantes </h3>
        ...
        <div className="card-body">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginTop: '1.5rem' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '1rem' }}>Tentativas</div>
              <p>você tem até três tentativas</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '1rem' }}>Zera o teste</div>
              <p>Você pode reiniciar o teste</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '1rem' }}>Persistência</div>
              <p>Seu progresso é salvo automaticamente</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '2rem', marginBottom: '1rem' }}>Pontuação</div>
